...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	public EarthquakeMarker (PointFeature feature) 
	{
		...
		deep = Float.parseFloat(properties.get("depth").toString());
		age = properties.get("age").toString();
	}
	...
	private void colorDetermine(PGraphics pg) {
		if (deep < 70) {
			pg.fill(pg.color(250, 250, 0));
		} else if (deep < 300) {
			pg.fill(pg.color(0, 0, 180));
		} else if (deep > 300) {
			pg.fill(pg.color(180, 0, 0));
		}
